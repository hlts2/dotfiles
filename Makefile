...
link:
	...
	ln -sfv $(dir $(abspath $(lastword $(MAKEFILE_LIST))))gitattributes_global $(HOME)/.gitattributes_global
	ln -sfv $(dir $(abspath $(lastword $(MAKEFILE_LIST))))gitignore_global $(HOME)/.gitignore_global
